...
const HorizontalCardProduct = ({ category, heading }) => {
  ...
  // also getting the no of products a user has in the cart through context provider
      ...
      >
        ...
        {loading
          ? loadingList.map((product, index) => {
              return (
                <div className="w-full min-w-[290px] md:min-w-[320px] max-w-[290px] md:max-w-[320px] h-36 bg-white rounded-sm shadow-md flex ">
                  ...
                  <div className="p-4 grid w-full gap-2 ">
                    ...
                    <div className="flex gap-3 w-full">
                      <p className="font-medium text-red-600 p-1 bg-slate-200 w-full  animate-pulse rounded-full">
                      </p>
                      <p className="text-slate-500 line-through p-1 bg-slate-200 w-full  animate-pulse rounded-full">
                      </p>
                    </div>
                    <button className=" text-sm text-white px-3 py-0.5 bg-slate-200  animate-pulse rounded-full w-full ">
                    </button>
                  </div>
                </div>
              );
          ...
          : data.map((product, index) => {
              return (
                <Link to={"product/"+ product?._id} className="w-full min-w-[290px] md:min-w-[320px] max-w-[290px] md:max-w-[320px] h-36 bg-white rounded-sm shadow-md flex ">
