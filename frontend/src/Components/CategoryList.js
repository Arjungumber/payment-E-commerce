        ...
        {loading
          ...
          : categoryProduct.map((product, index) => {
              return (
                ...
                >
                  {/* here giving resposnivenenss to the structure sing md: for screen size greater or equal it will follow the md : h and w */}
                  <div className=" w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden p-4 bg-slate-200 flex justify-center items-center">
                    ...
                    />
                    {/* this object-scle-down adjust the size of image automatically, mix-blend-multiply removes the inherit background of our image  */}
                  </div>
